...
* - Global scope: applies in EVERY country where 6ix operates or is accessed.
* - Explicit monitoring/detection, anti-abuse, incident response, and cooperation principles.
* - Clear platform rules mapped to cybercrime themes (including Nigeria’s Cybercrimes Act framing).
* - UI: wide, modern cards; no “note filler walls”; deep, practical content.
*/
