...
/**
* 6ix — Safety & Minors
* Cards-first layout; wide content for desktop with solid mobile behavior.
* No “note:” lines; everything is presented as cards, flows, scenarios, and playbooks.
* Includes extended playbooks rendered as cards for depth without clutter.
*/
