...
/**
* 6ix — Copyright / DMCA
* - Cards-first UI, wide layout, no “note:” spam.
* - Clear flows for DMCA notices, counter-notices, repeat-infringer actions, and restoration.
* - Practical music/streaming guidance, UGC fingerprinting, open licenses, public domain.
* - Scenarios/Playbooks sections to keep content actionable without low-value boilerplate.
*/
