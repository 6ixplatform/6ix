    ...
    return (
        <PageShell
            title="6ix — Disputes & Chargebacks"
             lead={<>Please contact us before filing a dispute. Many issues are resolved quickly via <a className="link-muted" href="mailto:billing@6ixapp.com">billing@6ixapp.com</a>. See also <Ref href="/legal/refunds">Refunds & Cancellations</Ref>.</>}
        >
            <Toc items={toc} />
            ...
            <Section id="work-with-us" heading="2) Work with us first">
                <Split>
            ...
            <Section id="chargeback-flow" heading="3) Chargeback flow">
            ...
            <Section id="evidence" heading="4) Evidence we provide">
                <Card>
            ...
            <Section id="account-impact" heading="5) Impact on account">
                <Split>
            ...
            <Section id="fraud" heading="6) Fraud & abuse">
                <Card>
                    <p className="text-zinc-300">
