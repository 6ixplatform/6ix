...
/* --- normalize Whisper language to avoid 'en-US' error --- */
const WHISPER_LANGS = new Set([
    'af', 'ar', 'az', 'be', 'bg', 'bs', 'ca', 'cs', 'cy', 'da', 'de', 'el', 'en', 'es', 'et', 'fa', 'fi', 'fr', 'gl', 'he', 'hi', 'hr', 'hu', 'hy',
    'id', 'is', 'it', 'iw', 'ja', 'kk', 'kn', 'ko', 'lt', 'lv', 'mi', 'mk', 'mr', 'ms', 'ne', 'nl', 'no', 'pl', 'pt', 'ro', 'ru', 'sk', 'sl', 'sr',
...
Always greet the user by this name in your first reply, and use it naturally and professionally (not every sentence).
...
`.trim();
        ...
        return NextResponse.json({
            client_secret: data.client_secret, // may be string or {value}
            iceServers,
