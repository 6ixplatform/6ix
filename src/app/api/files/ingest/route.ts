// App Router — POST /api/files/ingest
...
export async function POST(req: NextRequest) {
    const supabase = getSupabaseAdmin(); // ← create the client here
    ...
    try {
        ...
        // ensure bucket exists (ignore “already exists”)
        ...
        for (const file of files) {
            ...
            out.push({ name, mime, size, url: data.publicUrl });
        }
